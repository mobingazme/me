        ...
        <div id='skills'  className='md:px-12 px-4 '>
            <div className='grid grid-cols-1 md:grid-cols-5 items-center  '>
                <div  className='col-span-1 md:col-span-2' >
                    ...
                    <h2 data-aos="fade-up" data-aos-duration="1500" data-aos-easing="ease-in-sine" className='md:text-5xl text-2xl font-bold my-5'>چرا من را برای پروژه بعدی استخدام کنید؟</h2>
