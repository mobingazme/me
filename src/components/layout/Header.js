...
function Header() {
    return (
        <div  className='bg-A w-full max-w-7xl h-28 md:h-20 flex flex-col md:flex md:flex-row justify-center md:justify-between items-center md:p-8 fixed z-50 shadow-lg '>
